...
-file("/home/zangther/prog/logo-interpreter/logoscanner.erl", 324).
yystate() -> 14.
...
yystate(14, [48|Ics], Line, Tlen, Action, Alen) ->
...
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
